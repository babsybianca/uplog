defmodule UplogWeb.OrganizationControllerTest do
  use UplogWeb.ConnCase

  alias Uplog.Borrowables

  @create_attrs %{active: true, description: "some description", name: "some name", visible: true}
  ...
  def fixture(:organization) do
    {:ok, organization} = Borrowables.create_organization(@create_attrs)
    organization
  end
